...
function getTopNavItems(
	...
	return topnav?.filter((i): i is ISbStoryData<any> => {
...
function DesktopNavigation({
	...
	return (
		<nav {...props}>
			<ul
				className="flex rounded-full bg-white/90 px-3 text-sm font-headline font-medium text-zinc-800 ring-1 shadow-lg shadow-zinc-800/5 ring-zinc-900/5 backdrop-blur-sm dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10">
...
function MobileNavigation(
	...
	return (
		<Popover {...props}>
			<PopoverButton
				className="group flex items-center rounded-full bg-white/90 px-4 py-2 text-sm font-headline font-medium text-zinc-800 ring-1 shadow-lg shadow-zinc-800/5 ring-zinc-900/5 backdrop-blur-sm dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10 dark:hover:ring-white/20">
				Menu
			...
			>
				...
				<nav className="mt-6">
					<ul className="-my-2 divide-y divide-zinc-100 text-base font-headline text-zinc-800 dark:divide-zinc-100/5 dark:text-zinc-300">
...
function Avatar({ large = false, className, ...props }: Omit<React.ComponentPropsWithoutRef<typeof Link>, 'href'> & {
	large?: boolean
}) {
	return (
		<Link
